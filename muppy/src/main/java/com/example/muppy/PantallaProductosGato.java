...
public class PantallaProductosGato {
    ...
    void mostrarProducto(MouseEvent event) {
        String cantidad;
        cantidad = this.productosPerro.getText();
        //Producto productitos = new ProductoGatos();
        try{
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("PetysElimOlor.fxml"));
